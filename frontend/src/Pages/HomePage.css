...
:root {
  ...
  --gradient: linear-gradient(135deg, #0f62fe, #3b82f6);
}
...
.btn-primary {
  ...
  cursor: pointer;
  transition: all 0.2s;
  box-shadow: 0 4px 20px rgba(243, 242, 249, 0.4);
}
...
.cta-section {
  text-align: center;
  padding: 4rem 2rem;
  background: linear-gradient(135deg, rgba(15, 98, 254, 0.05), rgba(37, 99, 235, 0.05));
...
.btn-join {
  background: linear-gradient(135deg, #ffa502, #ff6584);
  color: #fff;
  border: none;
